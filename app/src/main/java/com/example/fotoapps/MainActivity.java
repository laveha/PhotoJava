...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        });//parent получаем лист view
    }
    private void loadImagesFromCache(){//подгружает фото которое уже есть приложение
    ...
    protected void onActivityResult(int requestCode, int ResultCode, Intent data){
        ...
        if (requestCode == PHOTO_ID){
            ...
            Uri imageUri = saveImageStorege(photo);
            if (imageUri != null){
                images.add(imageUri);
                adapter.notifyDataSetChanged();
            }
    ...
    private Uri saveImageStorege(Bitmap bitmapImage){
